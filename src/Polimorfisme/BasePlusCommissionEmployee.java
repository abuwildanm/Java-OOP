...
public class BasePlusCommissionEmployee extends CommissionEmployee {
    ...
    public BasePlusCommissionEmployee(String name, String noKTP, int banyakBarang, double sales, double rate, double salary) {
        super(name, noKTP, banyakBarang, sales, rate);
        setBaseSalary(salary);
    }
